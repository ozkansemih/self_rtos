...
#define PCD8544_DC_PIN 		GPIO_Pin_13
#define PCD8544_BL_PIN 		GPIO_Pin_15
#define PCD8544_PORT 		GPIOE
#define PCD8544_CE_PORT 	GPIOE
#define PCD8544_CE_PIN 		GPIO_Pin_9
...
void PCD8544_set_contrast( void);
void PCD8544_set_display( void );
void reset_Screen( void );
void clear_Screen( void );
void put_char_nOKIA ( char ch);
void put_str_nOKIA ( char* ch);
void set_adress(int x, int y);
void put_str_wAdress(int x, int y, char * );
void put_char_wAdress(int x, int y, char );
void shift_forward ( int * , int * , char * );
void shift_backward ( int * , int * , char * );
...
,{0x00, 0x10, 0x08, 0x08, 0x10, 0x08} // 7e a??
,{0x00, 0x78, 0x46, 0x41, 0x46, 0x78} // 7f a?¡¯
};
